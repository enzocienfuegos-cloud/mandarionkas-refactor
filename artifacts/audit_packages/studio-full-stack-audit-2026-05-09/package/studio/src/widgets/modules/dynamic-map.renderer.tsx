...
import {
  ...
  DYNAMIC_MAP_BRAND_PALETTE,
  DYNAMIC_MAP_TILE_URL,
  DYNAMIC_MAP_THEME_PALETTE,
  DYNAMIC_MAP_TOOLTIP_STYLES,
  haversineKm,
...
const dynamicMapPalette = DYNAMIC_MAP_THEME_PALETTE;
const dynamicMapBrandPalette = DYNAMIC_MAP_BRAND_PALETTE;
const mapTooltipStyles = DYNAMIC_MAP_TOOLTIP_STYLES;
  ...
  return `
    <div style="min-width:190px;color:${dynamicMapPalette.ink900};">
      ...
      <div style="display:flex;gap:8px;margin-top:10px;">
        <a href="${buildPlaceCtaUrl(place, 'waze')}" target="_blank" rel="noreferrer" style="display:inline-flex;flex:1;align-items:center;justify-content:center;height:32px;border-radius:12px;color:${dynamicMapPalette.white};font-size:10px;font-weight:800;text-decoration:none;background:${dynamicMapBrandPalette.wazeBlue};">Waze</a>
        <a href="${buildPlaceCtaUrl(place, 'maps')}" target="_blank" rel="noreferrer" style="display:inline-flex;flex:1;align-items:center;justify-content:center;height:32px;border-radius:12px;color:${dynamicMapPalette.white};font-size:10px;font-weight:800;text-decoration:none;background:${dynamicMapBrandPalette.mapsBlue};">Maps</a>
      </div>
    </div>
  `;
}
