...
function buildStoryFlowCanvasStyle(canvasSize: { width: number; height: number }): CSSProperties {
  return {
...
function buildStoryFlowNodeStyle(point: FlowPoint): CSSProperties {
  return {
    left: point.x,
    top: point.y,
    width: NODE_WIDTH,
  ...
  return (
    <div className="story-flow-canvas-shell">
      ...
      <div className="story-flow-canvas-scroll">
        <div className="story-flow-canvas" style={buildStoryFlowCanvasStyle(canvasSize)}>
          <svg
          ...
          {scenes.map((scene, index) => {
            ...
            return (
              <div
                ...
                style={buildStoryFlowNodeStyle(point)}
