    ...
    <section className="section section-premium">
      ...
      <div className="field-stack">
        ...
        {rows.map((row) => {
          ...
          return (
            <Tile key={row.key}>
              <div className="meta-line meta-line--between"><strong>{row.label}</strong>{binding ? <Button variant="ghost" size="sm" onClick={() => updateWidgetBinding(widget.id, row.key, undefined)}>Clear</Button> : null}</div>
