...
function buildDragTokenStyle(
  ...
  return {
    ...
    width: tokenSize,
    height: tokenSize,
    border: `2px solid ${accentColor ?? 'rgba(255,255,255,0.35)'}`,
    boxShadow: isDisabled ? 'none' : `0 0 14px ${accentColor ?? 'rgba(255,255,255,0.25)'}`,
...
function buildDragTokenGhostStyle(
  ...
  return {
    ...
    height: tokenSize,
    border: `2px solid ${accentColor ?? 'rgba(255,255,255,0.35)'}`,
    boxShadow: `0 14px 30px rgba(0,0,0,0.28), 0 0 18px ${accentColor ?? 'rgba(255,255,255,0.25)'}`,
  };
}
