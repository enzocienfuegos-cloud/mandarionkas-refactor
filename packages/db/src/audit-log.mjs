export const ACTION_TYPES = new Set([
  ...
  'studio.brand.created',
  'studio.invite.created',
  'studio.project.saved',
  'studio.project.deleted',
  'studio.project.duplicated',
  'studio.project.archived',
  'studio.project.restored',
  'studio.project.owner_changed',
  'studio.project.version_saved',
  'studio.asset.created',
  'studio.asset.deleted',
  'studio.asset.updated',
  'studio.asset.folder_created',
  'studio.asset.folder_deleted',
  'studio.asset.folder_renamed',
  'workspace.updated',
  'webhook.created',
  'webhook.deleted',
