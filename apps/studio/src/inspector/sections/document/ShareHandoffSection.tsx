...
export function ShareHandoffSection(): JSX.Element {
  ...
  return (
    <div className="field-stack">
      ...
      <div className="meta-line">
        <button onClick={() => void handleCopyLink()}>Copy link</button>
        <button onClick={handleExportPreflight}>Export preflight</button>
        <button onClick={handleExportReview}>Export review package</button>
      </div>
