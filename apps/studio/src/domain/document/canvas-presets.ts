...
export const CANVAS_PRESETS: CanvasPreset[] = [
  ...
  { id: 'wide-skyscraper', label: 'Skyscraper · 300×600', category: 'display', width: 300, height: 600, backgroundColor: '#ffffff', iabStandard: true, mraidStandard: true, mraidPlacement: 'inline' },
  { id: 'interstitial', label: 'Interstitial · 320×480', category: 'display', width: 320, height: 480, backgroundColor: '#ffffff', iabStandard: true, mraidStandard: true, mraidPlacement: 'interstitial' },
  { id: 'banner-mobile', label: 'Banner · 320×50', category: 'display', width: 320, height: 50, backgroundColor: '#ffffff', iabStandard: true, mraidStandard: true, mraidPlacement: 'banner' },
...
export function getIabStandardPresets(): CanvasPreset[] {
  return CANVAS_PRESETS.filter((preset) => preset.iabStandard);
}

export function getMraidStandardPresets(): CanvasPreset[] {
  return CANVAS_PRESETS.filter((preset) => preset.mraidStandard);
}

export function getPresetForSize(width: number, height: number): CanvasPreset | undefined {
  return CANVAS_PRESETS.find((preset) => preset.width === width && preset.height === height);
}
