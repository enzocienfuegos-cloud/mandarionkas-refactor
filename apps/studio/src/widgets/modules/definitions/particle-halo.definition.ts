...
import { ParticleHaloLibraryPreview, ParticleHaloThumb } from '../../registry/widget-thumbnails';

export const ParticleHaloDefinition = createModuleDefinition({
  type: 'particle-halo',
  label: 'Particle Halo',
  category: 'interactive',
  thumbnail: ParticleHaloThumb,
  renderLibraryPreview: ParticleHaloLibraryPreview,
