...
export function renderScratchRevealExport(node: WidgetNode): string {
  ...
  const revealAnimationPreset = String(node.props.revealAnimationPreset ?? 'none');
