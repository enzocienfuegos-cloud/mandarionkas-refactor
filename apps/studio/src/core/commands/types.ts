...
export type StudioCommand =
  ...
  | { type: 'ADD_CANVAS_VARIANT'; presetId: string }
  | { type: 'SELECT_CANVAS_VARIANT'; variantId: string }
  | { type: 'RENAME_CANVAS_VARIANT'; variantId: string; label: string }
  | { type: 'DUPLICATE_CANVAS_VARIANT'; variantId: string }
  ...
  | { type: 'SET_PREVIEW_CONTEXT'; previewContext: import('../../domain/preview/preview-frames').PreviewFrameId }
