...
import type { ProjectVersionRepository, ProjectVersionSummary } from '../../repositories/types';
...
export const browserStorageProjectVersionRepository: ProjectVersionRepository = {
