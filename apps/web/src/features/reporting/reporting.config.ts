...
const allWidgets = [
  ...
  { id: 'inventory-sources', type: 'inventorySources', title: 'Sites & apps', icon: 'geo', tone: 'slate', size: 'medium', order: 6, defaultVisible: true, visibleIn: ['all', 'display', 'video'] },
  { id: 'top-regions', type: 'topRegions', title: 'Top regions', icon: 'geo', tone: 'violet', size: 'medium', order: 7, defaultVisible: true, visibleIn: ['all', 'display', 'video', 'identity'] },
  { id: 'top-creatives', type: 'topCreatives', title: 'Top creatives', icon: 'creative', tone: 'fuchsia', size: 'medium', order: 8, defaultVisible: true, visibleIn: ['all', 'display', 'video'] },
  { id: 'tracker-health', type: 'trackerHealth', title: 'Tracker health', icon: 'tracker', tone: 'amber', size: 'medium', order: 9, defaultVisible: true, visibleIn: ['all', 'display', 'video'] },
  { id: 'recommendations', type: 'recommendations', title: 'Insights & recommendations', icon: 'health', tone: 'slate', size: 'medium', order: 10, defaultVisible: true, visibleIn: ['all', 'display', 'video', 'identity'] },
