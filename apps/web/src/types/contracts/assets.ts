...
export type RenameAssetFolderRequestDto = {
  name: string;
};

export type RenameAssetFolderResponseDto = {
  folder: AssetFolderDto;
};

export type MoveAssetRequestDto = {
  folderId?: string;
};

export type UpdateAssetQualityRequestDto = {
  qualityPreference: AssetQualityPreferenceDto;
};
