...
import type { ExportBuildOptions, ExportQualityProfileName } from '../../../export/engine';
...
export type ExportReadinessController = {
  ...
  setQualityProfile(value: ExportQualityProfileName): void;
  ...
  triggerExportHtml(state: StudioState, options?: ExportBuildOptions): void;
  triggerExportManifest(state: StudioState, options?: ExportBuildOptions): void;
  triggerExportDocumentJson(state: StudioState): void;
  triggerExportPackageFiles(state: StudioState, options?: ExportBuildOptions): void;
  triggerExportPublishPackage(state: StudioState, options?: ExportBuildOptions): void;
  triggerExportReviewPackage(state: StudioState, options?: ExportBuildOptions): void;
};
