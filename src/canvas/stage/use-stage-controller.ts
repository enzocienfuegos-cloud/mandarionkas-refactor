...
import { useSceneActions, useTimelineActions, useUiActions, useWidgetActions, useWidgetBehaviorActions } from '../../hooks/use-studio-actions';
...
export function useStageController(workspaceRef: React.RefObject<HTMLDivElement>, stageRef: React.RefObject<HTMLDivElement>) {
  ...
  const widgetBehaviorActions = useWidgetBehaviorActions();
