...
export type StudioCommand =
  ...
  | { type: 'SET_ACTIVE_ACTION'; actionId?: string }
  ...
  | { type: 'ADD_WIDGET_ACTION'; widgetId: string; trigger?: ActionTrigger; actionType?: ActionType; initialPatch?: Partial<ActionNode> }
